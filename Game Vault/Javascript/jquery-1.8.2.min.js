...
(function(a,b){
	...
	function bF(a){
		return 
			typeof a.getElementsByTagName!="undefined"?a.getElementsByTagName("*"):
	...
	function cY(a,b,c){
		var d,e,f,g,h,i,j,k,l=this,
			m=a.style,n={},o=[],q=a.nodeType&&bZ(a);
		c.queue||(j=p._queueHooks(a,"fx"),
		j.unqueued==null&&(j.unqueued=0,k=j.empty.fire,j.empty.fire=function(){
	...
	var c,d,e=a.document,
		...
		p=function(a,b){
			...
			C=function(a,b){
				...
				D=function(){
					e.addEventListener?(
						e.removeEventListener("DOMContentLoaded",D,!1),
							...
							init:function(a,c,d){
								...
								if(typeof a=="string"){
									...
									if(f&&(f[1]||!c)){
										if(f[1])
											return c=c 
										instanceof p?c[0]:c,i=c&&c.nodeType?
											c.ownerDocument||c:e,
								...
								return p.isFunction(a)?d.ready(a):(
									a.selector!==b&&(
									...
									return a==null?
										...
										pushStack:function(a,b,c){
											...
											return d.prevObject=this,
												...
												b==="find"?d.selector=this.selector+(this.selector?" ":"")+
						...
						p.fn.init.prototype=p.fn,p.extend=p.fn.extend=function(){
							...
							typeof h!="object"&&!p.isFunction(h)&&(h={}),j===i&&(h=this,--i);
							for(;i<j;i++)
																					...
																					b&&r.test(b)&&(a.execScript||function(b){
																						...
																						function(a){
																							return a==null?"":(a+"").replace(t,"")},
																								...
																								map:function(a,c,d){
																									var e,f,g=[],h=0,i=a.length,j=a 
																									instanceof p||i!==b&&
																									typeof i=="number"&&(i>0&&a[0]&&a[i-1]||i===0||p.isArray(a));
																									if(j)
																										for(;h<i;h++)
						...
						p.each("Boolean Number String Function Array Date RegExp Object".split(" "),
							function(a,b){
								...
								p.extend({
									...
									when:function(a){
										var b=0,c=k.call(arguments),
											d=c.length,e=d!==1||a&&p.isFunction(a.promise)?d:0,
								...
								p.support=function(){
									...
									h=n.getElementsByTagName("input")[0],b={
										...
										tbody:!n.getElementsByTagName("tbody").length,htmlSerialize:!!n.getElementsByTagName("link").length,style:/top/.test(d.getAttribute("style")),
										hrefNormalized:d.getAttribute("href")==="/a",
										opacity:/^0.5/.test(d.style.opacity),
										cssFloat:!!d.style.cssFloat,
										checkOn:h.value==="on",
										optSelected:g.selected,
										getSetAttribute:n.className!=="t",enctype:!!e.createElement("form").enctype,html5Clone:e.createElement("nav").cloneNode(!0).outerHTML!=="<:nav></:nav>",
									...
									h.checked=!0,
									b.noCloneChecked=h.cloneNode(!0).checked,f.disabled=!0,
									...
									!n.addEventListener&&n.attachEvent&&n.fireEvent&&(n.attachEvent(
										"onclick",m=function(){
											b.noCloneEvent=!1
										}
									),
									...
									if(n.attachEvent)
										for(k in{
											...
											return p(function(){
												...
												b.reliableHiddenOffsets=l&&f[0].offsetHeight===0,d.innerHTML="",
												d.style.cssText="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",
												b.boxSizing=d.offsetWidth===4,
												b.doesNotIncludeMarginInBodyOffset=i.offsetTop!==1,a.getComputedStyle&&(b.pixelPosition=(a.getComputedStyle(d,null)||{}).top!=="1%",
												...
												hasData:function(a){
													return a=a.nodeType?p.cache[a[p.expando]]:a[p.expando],
														...
														data:function(a,c,d,e){
															if(!p.acceptData(a))
																return;
															var f,g,h=p.expando,i=typeof c=="string",
																j=a.nodeType,k=j?p.cache:a,l=j?a[h]:a[h]&&h;
														...
														removeData:function(a,b,c){
															...
															delete h[i]:h[i]=null},_data:function(a,b,c){
													...
													p.fn.extend({
														queue:function(a,c){
															...
															arguments.length<d?p.queue(this[0],a):c===b?
														...
														clearQueue:function(a){
															...
															promise:function(a,c){
																var d,e=1,f=p.Deferred(),
																g=this,h=this.length,i=function(){
																	--e||f.resolveWith(g,[g])
																};
																typeof a!="string"&&(c=a,a=b),a=a||"fx";while(h--)d=p._data(g[h],a+"queueHooks"),
														...
														attr:function(a,c,d,e){
															...
															removeAttr:function(a,b){
																var c,d,e,f,g=0;if(b&&a.nodeType===1){
																	...
																	for(;g<d.length;g++)
																		e=d[g],
																		e&&(c=p.propFix[e]||e,f=T.test(e),f||p.attr(a,e,""),
													...
													p.event={add:function(a,c,d,e,f){
														...
														if(a.nodeType===3||a.nodeType===8||!c||!d||!(g=p._data(a)))
															return;d.handler&&(o=d,d=o.handler,f=o.selector),
															...
															h=g.handle,h||(g.handle=h=function(a){
																...
																for(j=0;j<c.length;j++){
																	...
																	p.event.global[l]=!0}a=null},
																	global:{},remove:function(a,b,c,d,e){
																		var f,g,h,i,j,k,l,m,n,o,q,r=p.hasData(a)&&p._data(a);
																		if(!r||!(m=r.events))
																			return;b=p.trim(_(b||"")).split(" ");
																		...
																		if(!f||f.nodeType!==3&&f.nodeType!==8){
																			...
																			if(!g&&!n.noBubble&&!p.isWindow(f)){
																				...
																				for(l=f;k;k=k.parentNode)
																					q.push([k,r]),
																					l=k;l===(f.ownerDocument||e)&&q.push([l.defaultView||l.parentWindow||a,r])
																			}
																			for(j=0;j<q.length&&!c.isPropagationStopped();j++)
																				...
																				return c.type=s,
																					!g&&!c.isDefaultPrevented()&&(!n._default||n._default.apply(f.ownerDocument,d)===!1)&&(s!=="click"||!p.nodeName(f,"a"))&&p.acceptData(f)&&m&&f[s]&&(s!=="focus"&&s!=="blur"||c.target.offsetWidth!==0)&&!p.isWindow(f)&&(l=f[m],l&&(f[m]=null),
																					p.event.triggered=s,f[s](),
																					p.event.triggered=b,l&&(f[m]=l)),
																					c.result}return
																	},
																	dispatch:function(c){
																		c=p.event.fix(c||a.event);
																		var d,e,f,g,h,i,j,l,m,n,o=(p._data(this,"events")||{})[c.type]||[],
																			q=o.delegateCount,r=k.call(arguments),
																				...
																				for(d=0;d<u.length&&!c.isPropagationStopped();d++){
																					...
																					for(e=0;e<i.matches.length&&!c.isImmediatePropagationStopped();e++){
																						...
																						if(s||!c.namespace&&!l.namespace||c.namespace_re&&c.namespace_re.test(l.namespace))
																							...
																							g!==b&&(c.result=g,g===!1&&(c.preventDefault(),
																							c.stopPropagation()))
																					}
																				}
																	...
																	mouseHooks:{
																		...
																		filter:function(a,c){
																			...
																			return a.pageX==null&&c.clientX!=null&&(d=a.target.ownerDocument||e,f=d.documentElement,g=d.body,a.pageX=c.clientX+(f&&f.scrollLeft||g&&g.scrollLeft||0)-(f&&f.clientLeft||g&&g.clientLeft||0),
																				a.pageY=c.clientY+(f&&f.scrollTop||g&&g.scrollTop||0)-(f&&f.clientTop||g&&g.clientTop||0)),
																				!a.relatedTarget&&i&&(a.relatedTarget=i===a.target?c.toElement:i),
																				!a.which&&h!==b&&(a.which=h&1?1:h&2?3:h&4?2:0),a
																		}
																	},
																	fix:function(a){
																		if(a[p.expando])
																				...
																				simulate:function(a,b,c,d){
																					...
																					p.removeEvent=e.removeEventListener?function(a,b,c){
																						a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){
																							var d="on"+b;a.detachEvent&&(typeof a[d]=="undefined"&&(a[d]=null),
																							a.detachEvent(d,c))},
																							p.Event=function(a,b){
																								if(this instanceof p.Event)a&&a.type?(this.originalEvent=a,
																									this.type=a.type,
